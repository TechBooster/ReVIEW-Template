= 俺はただスコアリングアプリが作りたいんだ！
//lead{
この本を読むことによって開発できるAIアプリについて
私がデータサイエンティストになった理由をはさみながらご紹介します。
//}
@<kw>{POINT}
@<comment>{ここの文章はあとで精査する}
 1. データを使ってどんな仕組みを作りたいのかを考えてみる
 2. 私が必要な仕組みはスコアリングモデルである
 3. 今回開発するアプリはスコアリングアプリである
