...
しかし、個人的には、上記、述べたとおりVue.jsに必要なミドルウェアやプロジェクト構成がすべて用意されている、というのがNuxt.jsのメリットであるます。
...
Nuxt.js/Vue.jsだとプログラマーブルに、冗長なく書けるのがうれしいところです。
...
APIにアクセスしていなにか、値を取得したい！という場合はActionsを使います。
